...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        await interaction.reply({
            content: `${interaction.user.username} just checked out Alex Belli's stats! 📊`,
            ephemeral: false
        });
        ...
        const auth = new google.auth.GoogleAuth({
                ...
                const response = await sheets.spreadsheets.values.get({
                    ...
                    range: 'DBFL Records (2025 Edition)!C4:T4'
                });
                ...
                getPlayerAchievements(client,'1xREw4GOWNdrfecTE13t4uWIstXvR5WdhGiwK1PjLWXE', 'Alex', 4, touchdowns, yards, def_ints, filler1, filler2, filler3);
        ...
        .setImage('https://cdn.discordapp.com/attachments/1220085546190110900/1362137264007807016/Alex_DBFL_2025.gif?ex=68014caf&is=67fffb2f&hm=1ed27e3558a2ccb8b11546ed41d8a385aa22a479c7dcdebdae9c31968b5ffc53&')
        .setFooter({
