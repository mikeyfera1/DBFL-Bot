...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        await interaction.reply({
            content: `${interaction.user.username} just checked out Bear Bottonari's stats! 📊`,
            ephemeral: false
        });
        ...
        const auth = new google.auth.GoogleAuth({
                ...
                const response = await sheets.spreadsheets.values.get({
                    ...
                    range: 'DBFL Records (2025 Edition)!C3:T3'
                });
            ...
            getPlayerAchievements(client,'1xREw4GOWNdrfecTE13t4uWIstXvR5WdhGiwK1PjLWXE', 'Bear', 3, touchdowns, yards, def_ints, filler1, filler2, filler3);
        ...
        .setImage('https://cdn.discordapp.com/attachments/1220085546190110900/1362246317606441050/Bear_DBFL_2025.gif?ex=6801b23f&is=680060bf&hm=f8058dee3474c83ef262973d2f9e3214e68c9c1ec83d74a76709a7674fbbc36a&')
        .setFooter({
