...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        await interaction.reply({
            content: `${interaction.user.username} just checked out Cole Jooste's stats! 📊`,
            ephemeral: false
        });
        ...
        const auth = new google.auth.GoogleAuth({
                ...
                const response = await sheets.spreadsheets.values.get({
                    ...
                    range: 'DBFL Records (2025 Edition)!C9:T9'
                });
            ...
            getPlayerAchievements(client,'1xREw4GOWNdrfecTE13t4uWIstXvR5WdhGiwK1PjLWXE', 'Cole', 9, touchdowns, yards, def_ints, filler1, filler2, filler3);
