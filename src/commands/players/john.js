...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        await interaction.reply({
            content: `${interaction.user.username} just checked out John Hertzog's stats! 📊`,
            ephemeral: false
        });
        ...
        const auth = new google.auth.GoogleAuth({
                ...
                const response = await sheets.spreadsheets.values.get({
                    ...
                    range: 'DBFL Records (2025 Edition)!C14:T14'
                });
                ...
                getPlayerAchievements(client,'1xREw4GOWNdrfecTE13t4uWIstXvR5WdhGiwK1PjLWXE', 'John', 14, touchdowns, yards, def_ints, filler1, filler2, filler3);
        ...
        .setImage('https://cdn.discordapp.com/attachments/1221193514495381514/1391125272861868032/John_DBFL.gif?ex=686ac1de&is=6869705e&hm=11b84f7ebd6228d8a688152b0ffe3c6d93d1eb107b91387041aea31944abba4b&')
        .setFooter({
