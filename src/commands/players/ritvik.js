...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        await interaction.reply({
            content: `${interaction.user.username} just checked out Ritvik Shah's stats! 📊`,
            ephemeral: false
        });
        ...
        const auth = new google.auth.GoogleAuth({
                ...
                const response = await sheets.spreadsheets.values.get({
                    ...
                    range: 'DBFL Records (2025 Edition)!C5:T5'
                });
                ...
                getPlayerAchievements(client,'1xREw4GOWNdrfecTE13t4uWIstXvR5WdhGiwK1PjLWXE', 'Ritvik', 5, touchdowns, yards, def_ints, filler1, filler2, filler3);
