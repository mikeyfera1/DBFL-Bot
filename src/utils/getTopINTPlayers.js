...
async function getTopPlayersByINTs(sheetId, range = 'DBFL Records (2025 Edition)!A2:G18') {
    ...
    const sorted = players.sort((a, b) => b.ints - a.ints);

    // Return top 3
    return sorted.slice(0, 3);
}

module.exports = getTopPlayersByINTs;